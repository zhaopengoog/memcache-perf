...
struct gengetopt_args_info
{
  ...
  float getq_freq_arg; /**< @brief Ratio of multi-get:get commands. (default='0.0' i.e. no multi get).  */
  int getq_size_arg; /**< @brief Number of get requests per GETQ (default=50).  */
  char * update_orig;	/**< @brief Ratio of set:get commands. original value given at command line.  */
  char * getq_freq_orig;	/**< @brief Ratio of multi-get:get commands. original value given at command line.  */
  char * getq_size_orig;	/**< @brief Number of get requests per GETQ. original value given at command line.  */
  ...
  const char *getq_size_help; /**< @brief Number get req per getq. help description.  */
  const char *getq_freq_help; /**< @brief Ratio of getq to get. help description.  */
  ...
  unsigned int getq_freq_given ;	/**< @brief Whether getq freq was given.  */
  unsigned int getq_size_given ;	/**< @brief Whether getq freq was given.  */
